...
public class BbkPrototypeDeclarationStub extends StubBase<BbkPrototypeDeclaration>
        implements NamedStub<BbkPrototypeDeclaration> {
    ...
    public BbkPrototypeDeclarationStub(@Nullable StubElement<?> parent,
