...
public class BbkPreEndifDirectiveImpl extends BbkPsiElementBase implements BbkPreEndifDirective {

  public BbkPreEndifDirectiveImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPreEndifDirective(this);
  }
