...
public class BbkProcedureDeclarationImpl extends BbkStubBasedNamedElementMixin<BbkProcedureDeclarationStub> implements BbkProcedureDeclaration {

  public BbkProcedureDeclarationImpl(ASTNode node) {
    super(node);
  }

  public BbkProcedureDeclarationImpl(BbkProcedureDeclarationStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }
