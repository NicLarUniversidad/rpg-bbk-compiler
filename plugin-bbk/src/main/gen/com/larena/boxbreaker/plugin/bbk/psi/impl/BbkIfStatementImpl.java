...
public class BbkIfStatementImpl extends BbkPsiElementBase implements BbkIfStatement {

  public BbkIfStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BbkBlockStatement> getBlockStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BbkBlockStatement.class);
  }
