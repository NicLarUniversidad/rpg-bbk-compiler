...
public class BbkQualifiedModifierImpl extends BbkPsiElementBase implements BbkQualifiedModifier {

  public BbkQualifiedModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitQualifiedModifier(this);
  }
