...
public class BbkProcModifierImpl extends BbkPsiElementBase implements BbkProcModifier {

  public BbkProcModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitProcModifier(this);
  }
