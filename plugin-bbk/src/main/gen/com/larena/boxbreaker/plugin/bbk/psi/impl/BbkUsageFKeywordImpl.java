...
public class BbkUsageFKeywordImpl extends BbkPsiElementBase implements BbkUsageFKeyword {

  public BbkUsageFKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitUsageFKeyword(this);
  }
