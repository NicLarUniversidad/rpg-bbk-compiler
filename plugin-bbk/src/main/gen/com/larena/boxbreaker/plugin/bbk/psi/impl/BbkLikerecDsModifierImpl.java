...
public class BbkLikerecDsModifierImpl extends BbkPsiElementBase implements BbkLikerecDsModifier {

  public BbkLikerecDsModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitLikerecDsModifier(this);
  }
