...
public class BbkOtherClauseImpl extends BbkPsiElementBase implements BbkOtherClause {

  public BbkOtherClauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitOtherClause(this);
  }
