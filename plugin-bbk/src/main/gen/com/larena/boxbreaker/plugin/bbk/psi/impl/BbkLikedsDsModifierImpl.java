...
public class BbkLikedsDsModifierImpl extends BbkPsiElementBase implements BbkLikedsDsModifier {

  public BbkLikedsDsModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitLikedsDsModifier(this);
  }
