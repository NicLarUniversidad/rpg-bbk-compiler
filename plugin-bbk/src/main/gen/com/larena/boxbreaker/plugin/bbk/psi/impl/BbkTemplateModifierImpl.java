...
public class BbkTemplateModifierImpl extends BbkPsiElementBase implements BbkTemplateModifier {

  public BbkTemplateModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitTemplateModifier(this);
  }
