...
public class BbkLikeReferenceImpl extends BbkPsiElementBase implements BbkLikeReference {

  public BbkLikeReferenceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitLikeReference(this);
  }
