...
public class BbkConstWrapperImpl extends BbkPsiElementBase implements BbkConstWrapper {

  public BbkConstWrapperImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitConstWrapper(this);
  }
