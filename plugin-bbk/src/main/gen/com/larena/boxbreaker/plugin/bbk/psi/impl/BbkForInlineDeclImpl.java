...
public class BbkForInlineDeclImpl extends BbkPsiElementBase implements BbkForInlineDecl {

  public BbkForInlineDeclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitForInlineDecl(this);
  }
