...
public class BbkExtfileFKeywordImpl extends BbkPsiElementBase implements BbkExtfileFKeyword {

  public BbkExtfileFKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitExtfileFKeyword(this);
  }
