...
public class BbkAlignModifierImpl extends BbkPsiElementBase implements BbkAlignModifier {

  public BbkAlignModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitAlignModifier(this);
  }
