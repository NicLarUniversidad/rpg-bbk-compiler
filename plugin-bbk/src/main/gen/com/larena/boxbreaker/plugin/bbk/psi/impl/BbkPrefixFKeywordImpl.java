...
public class BbkPrefixFKeywordImpl extends BbkPsiElementBase implements BbkPrefixFKeyword {

  public BbkPrefixFKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPrefixFKeyword(this);
  }
