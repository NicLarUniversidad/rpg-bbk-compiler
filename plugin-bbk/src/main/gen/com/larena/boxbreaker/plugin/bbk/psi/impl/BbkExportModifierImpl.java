...
public class BbkExportModifierImpl extends BbkPsiElementBase implements BbkExportModifier {

  public BbkExportModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitExportModifier(this);
  }
