...
public class BbkBasedModifierImpl extends BbkPsiElementBase implements BbkBasedModifier {

  public BbkBasedModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitBasedModifier(this);
  }
