...
public class BbkPreUndefineDirectiveImpl extends BbkPsiElementBase implements BbkPreUndefineDirective {

  public BbkPreUndefineDirectiveImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPreUndefineDirective(this);
  }
