...
public class BbkRenameFKeywordImpl extends BbkPsiElementBase implements BbkRenameFKeyword {

  public BbkRenameFKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitRenameFKeyword(this);
  }
