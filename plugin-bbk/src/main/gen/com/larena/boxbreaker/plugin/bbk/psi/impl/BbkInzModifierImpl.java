...
public class BbkInzModifierImpl extends BbkPsiElementBase implements BbkInzModifier {

  public BbkInzModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitInzModifier(this);
  }
