...
public class BbkPreIncludeDirectiveImpl extends BbkPsiElementBase implements BbkPreIncludeDirective {

  public BbkPreIncludeDirectiveImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPreIncludeDirective(this);
  }
