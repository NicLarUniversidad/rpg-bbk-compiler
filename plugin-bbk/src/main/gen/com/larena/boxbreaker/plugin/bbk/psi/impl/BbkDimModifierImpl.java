...
public class BbkDimModifierImpl extends BbkPsiElementBase implements BbkDimModifier {

  public BbkDimModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitDimModifier(this);
  }
