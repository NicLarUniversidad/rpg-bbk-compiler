...
public class BbkExsrStatementImpl extends BbkPsiElementBase implements BbkExsrStatement {

  public BbkExsrStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitExsrStatement(this);
  }
