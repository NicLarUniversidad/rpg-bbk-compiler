...
public class BbkInfdsDsModifierImpl extends BbkPsiElementBase implements BbkInfdsDsModifier {

  public BbkInfdsDsModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitInfdsDsModifier(this);
  }
