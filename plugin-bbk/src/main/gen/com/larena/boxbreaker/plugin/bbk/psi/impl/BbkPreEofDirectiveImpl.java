...
public class BbkPreEofDirectiveImpl extends BbkPsiElementBase implements BbkPreEofDirective {

  public BbkPreEofDirectiveImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPreEofDirective(this);
  }
