...
public class BbkLeavesrStatementImpl extends BbkPsiElementBase implements BbkLeavesrStatement {

  public BbkLeavesrStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitLeavesrStatement(this);
  }
