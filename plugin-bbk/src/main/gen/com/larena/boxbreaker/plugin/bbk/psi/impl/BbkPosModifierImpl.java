...
public class BbkPosModifierImpl extends BbkPsiElementBase implements BbkPosModifier {

  public BbkPosModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPosModifier(this);
  }
