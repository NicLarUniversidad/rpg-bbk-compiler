...
public class BbkInfdsFKeywordImpl extends BbkPsiElementBase implements BbkInfdsFKeyword {

  public BbkInfdsFKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitInfdsFKeyword(this);
  }
