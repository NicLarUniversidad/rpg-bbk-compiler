...
public class BbkExtpgmModifierImpl extends BbkPsiElementBase implements BbkExtpgmModifier {

  public BbkExtpgmModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitExtpgmModifier(this);
  }
