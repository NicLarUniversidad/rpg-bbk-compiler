...
public class BbkPreElseDirectiveImpl extends BbkPsiElementBase implements BbkPreElseDirective {

  public BbkPreElseDirectiveImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BbkVisitor visitor) {
    visitor.visitPreElseDirective(this);
  }
